...
void traducao::leitura(string ArquivoEntrada)
{
    ...
    string H_INPUT("H_INPUT");
    string H_OUTPUT("H_OUTPUT");
    ...
    if(entrada.is_open())
    {
        ...
        for(unsigned int j=0;j<buffer_completo.size();j++)
        {
            ...
            if(buffer_completo[j].compare(TEXT)==0)
            {
                ...
                for(unsigned int i=j;i<buffer_completo.size();i++)
                {
                    ...
                    ///////////////////////////////H_INPUT///////////////////////////
                    if(buffer_completo[i].compare(H_INPUT)==0)
                    {
                    ...
                    ///////////////////////////////H_OUTPUT///////////////////////////
                    if(buffer_completo[i].compare(H_OUTPUT)==0)
                    {
        ...
        if(H_INPUT_FLAG){
            ...
            saida<<"LerHexa:"<<endl;
            saida<<"\tenter 26,0\n\txor eax,eax\n\tpush ebx\n\tpush ecx\n\tpush edx\n\tpush edi\n\tpush esi"<<endl;
            saida<<"\tmov eax,3\n\tmov ebx,0\n\tmov edx,12\n\tmov ecx,ebp\n\tsub ecx,18\n\tint 80h\n\tmov [ebp-22],eax\n\tmov [ebp-26],eax\n\tdec dword [ebp-22]\n\tmov dword ecx,[ebp-22]"<<endl;
            saida<<"\tmov edi,0\n\tmov esi,16\n\tmov eax,0\n\tmov ebx,0"<<endl;
            saida<<"retorna_hex:"<<endl;
            saida<<"\tcmp byte [ebp-18+edi],0x46\n\tjg erro_hex\n\tcmp byte [ebp-18+edi],0x30\n\tjl erro_hex"<<endl;
            saida<<"\tcmp byte [ebp-18+edi],0x3A\n\tjl zero_nove\n\tcmp byte [ebp-18+edi],0x40\n\tjg a_f\n\tjmp erro_hex"<<endl;
            saida<<"zero_nove:"<<endl;
            saida<<"\txor eax,eax\n\tmov al,[ebp-18+edi]\n\tsub eax,0x30\n\tmov dword ecx,[ebp-22]\n\tjmp retorna_mul"<<endl;
            saida<<"a_f:"<<endl;
            saida<<"\tcmp byte [ebp-18+edi],0x41\n\tje A_hex\n\tcmp byte [ebp-18+edi],0x42\n\tje B_hex\n\tcmp byte [ebp-18+edi],0x43"<<endl;
            saida<<"\tje C_hex\n\tcmp byte [ebp-18+edi],0x44\n\tje D_hex\n\tcmp byte [ebp-18+edi],0x45\n\tje E_hex\n\tcmp byte [ebp-18+edi],0x46\n\tje F_hex\n\tjmp erro_hex"<<endl;
            saida<<"A_hex:"<<endl;
            saida<<"\txor eax,eax\n\tmov eax,10\n\tmov dword ecx,[ebp-22]\n\tjmp retorna_mul"<<endl;
            saida<<"B_hex:"<<endl;
            saida<<"\txor eax,eax\n\tmov eax,11\n\tmov dword ecx,[ebp-22]\n\tjmp retorna_mul"<<endl;
            ...
            saida<<"F_hex:"<<endl;
            saida<<"\txor eax,eax\n\tmov eax,15\n\tmov dword ecx,[ebp-22]\n\tjmp retorna_mul"<<endl;
            saida<<"retorna_mul:"<<endl;
            saida<<"\tcmp ecx,1\n\tjbe soma_num\n\tmul esi\n\tdec ecx\n\tjmp retorna_mul"<<endl;
            saida<<"soma_num:"<<endl;
            saida<<"\tadd ebx,eax\n\tdec dword [ebp-22]\n\tcmp dword [ebp-22],0\n\tje guarda_hex\n\tinc edi\n\tjmp retorna_hex"<<endl;
            saida<<"guarda_hex:"<<endl;
            saida<<"\tmov eax,[EBP+8]\n\tmov dword [eax],ebx\n\tjmp final_hex"<<endl;
            saida<<"erro_hex:"<<endl;
            saida<<"\tmov eax,4\n\tmov ebx,1\n\tmov ecx,incorreto\n\tmov edx,28\n\tint 80h\n\tmov eax,1\n\tmov ebx,0\n\tint 80h"<<endl;
            saida<<"final_hex:"<<endl;
            saida<<"\tmov eax,[ebp-26]\n\tpop esi\n\tpop edi\n\tpop edx\n\tpop ecx\n\tpop ebx\n\tleave\n\tret 4"<<endl<<endl;
        ...
        if(H_OUTPUT_FLAG){
            ...
            saida<<"EscreverHexa:"<<endl;
            saida<<"\tenter 24,0\n\txor eax,eax\n\tpush ebx\n\tpush ecx\n\tpush edx\n\tpush edi\n\tpush esi"<<endl;
            saida<<"\tmov edi,[ebp+8]\n\tmov eax,[edi]\n\tmov edi,0\n\tmov ecx,0\n\tmov ebx,16\n\tcmp eax,0\n\tje zero_EH"<<endl;
            saida<<"positivo_EH:"<<endl;
            saida<<"\tcdq\n\tcmp eax,0\n\tje inicio_imprime_EH\n\tdiv ebx\n\tcmp edx,10\n\tje salva_A\n\tcmp edx,11\n\tje salva_B"<<endl;
            saida<<"\tcmp edx,12\n\tje salva_C\n\tcmp edx,13\n\tje salva_D\n\tcmp edx,14\n\tje salva_E\n\tcmp edx,15\n\tje salva_F\n\tadd edx,0x30\n\tjmp salva_EH"<<endl;
            saida<<"salva_A:"<<endl;
            saida<<"\tmov edx,'A'\n\tjmp salva_EH"<<endl;
            saida<<"salva_B:"<<endl;
            ...
            saida<<"\tmov edx,'F'\n\tjmp salva_EH"<<endl;
            saida<<"salva_EH:"<<endl;
            saida<<"\tmov [ebp-12+edi],edx\n\tinc edi\n\tmov [ebp-24],edi\n\tjmp positivo_EH"<<endl;
            saida<<"zero_EH:"<<endl;
            saida<<"\tadd eax,0x30\n\tmov [ebp-12],eax\n\tinc edi\n\tmov [ebp-24],edi\n\tjmp inicio_imprime_EH"<<endl;
            saida<<"inicio_imprime_EH:"<<endl;
            saida<<"\tmov byte [ebp-12+edi],0ah\n\tmov esi,edi"<<endl;
            saida<<"imprime_EH:"<<endl;
            saida<<"\tmov eax,4\n\tmov ebx,1\n\tmov ecx,ebp\n\tsub ecx,12\n\tadd ecx,edi\n\tmov edx,1\n\tint 80h\n\tcmp edi,0\n\tje fim_imprime_EH\n\tdec edi\n\tjmp imprime_EH"<<endl;
            saida<<"fim_imprime_EH:"<<endl;
            saida<<"\tmov eax,4\n\tmov ebx,1\n\tmov ecx,newline\n\tmov edx,NWLINESIZE\n\tint 80h"<<endl;
            saida<<"final_EH:"<<endl;
            saida<<"\tmov eax,[ebp-24]\n\tinc eax\n\tpop esi\n\tpop edi\n\tpop edx\n\tpop ecx\n\tpop ebx\n\tleave\n\tret 4"<<endl<<endl;
