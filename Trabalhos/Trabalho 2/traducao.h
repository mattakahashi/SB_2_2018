...
public:
	...
	//int Tabela_Instrucoes_Diretivas(string buffer_tokens);
...
private:
	...
	//vector<int> rotulos_linha,buffer_erro_lexico,buffer_caracter_invalido,buffer_erro_diretivas, buffer_erro_teste;
	string linha;
